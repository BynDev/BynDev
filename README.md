...
- **Client**: VR presentation with NPC state machine and event sequencing | **Backend**: Real-time heart rate streaming from Galaxy Watch via WebSocket | **Data Pipeline:** Timestamp-synchronized logging and time-series analysis for feedback validation
