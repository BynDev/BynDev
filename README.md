...
- **소개:** 플레이어의 신체 움직임에 따라 창문을 들여다보듯 시점이 변화하며, 나레이션과 함께 한국의 주요 관광 명소를 탐험하는 열차 관광 게임 **[컨셉]** 2D 화면에서도 입체감을 제공하는 "창문" 인터랙션 메타포 설계 및 구현 (인지심리이론 기반) **[렌더링]** 한국 랜드마크 모델링 + HDRP 포스트 프로세싱 **[게임플레이]** 스플라인 기반 열차 이동, AI 투어 음성, 몸동작으로 창 밖 콘텐츠 탐색 시나리오
