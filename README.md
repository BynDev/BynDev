...
- **Client**: Spline-based train gameplay with vibration effects & AI narration | **Interaction**: Body tracking motion parallax with real-time input filtering and camera frustum adjustment | **Graphics**: HDRP rendering pipeline with high-fidelity Korean landmark models
