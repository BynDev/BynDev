...
### 🌟 [**비벤(Viven)**](http://journal.dcs.or.kr/_common/do.php?a=full&b=12&bidx=3703&aidx=40968): *온라인 교육용 토의·토론 특화 메타버스 플랫폼 설계*
...
### 📊 [**컴파일럿(Calmpilot)**](https://github.com/BynPlay/Calmpilot): *VR 프로그램용 실시간 바이오 데이터 기반 적응형 햅틱 피드백 연구*
