...
저는 아트, 프로그래밍, 기획 등 다양한 직군과 유연하게 협업하며, 각 파트의 관점을 이해하고 하나의 경험으로 조율합니다. 또한 HCI(Human-Computer Interaction)를 통해 최신 기술 스택의 활용과 사용자 중심의 경험을 깊이 있게 탐구하고 분석하는 역량을 쌓았습니다.
...
- **Genre:** Motion Game | **Role**: TPM & Interaction Design | Team: Art 1 · Programming 4 
