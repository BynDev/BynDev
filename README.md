...
- **Client**: VR presentation environment with NPC state machine, timeline sequencing, ray-based interaction | **Backend**: WebSocket-based real-time heart rate streaming from Galaxy Watch via HypeRate API | **Data Pipeline:** Timestamp-synchronized logging, time-series preprocessing, statistical analysis for feedback validation
