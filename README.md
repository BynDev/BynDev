...
- **[Narrative]**  Storytelling, art direction, and interaction design for children aged 8–12 with ADHD. **[System]** Built medical AI model, converted to ONNX, and integrated into Unity for real-time gameplay adaptation **[Mechanics]**  Translated DSM-5 criteria into game scenarios that capture behavioral data, with full DB logging pipeline
