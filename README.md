...
- **Client**: 3DGS scene compositing & depth-based visualization in Unity with HLSL Compute Shader | **Streaming**: TCP-based 360° video streaming with GPU-accelerated FFmpeg & NVIDIA NPP pipeline | **Backend**: Remote GPU orchestration & automated SfM→3DGS training via Python SSH/SFTP
...
### 📊 **Calmpilot**: *Real-time Biometric Data Pipeline for Adaptive Haptic Feedback in VR*
