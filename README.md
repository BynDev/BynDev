...
### 🔮 [**CrossGaussian**](https://www.youtube.com/watch?v=j1E37wnWhfA): *Remote collaboration interaction research using game engine and 3DGS neural rendering*
- **Role**: Research Lead (Research Design & TPM) | **Team**: Client 2 · Backend & Distributed system 2 · Data Anaysis 1
- **Introduce:** **HCI research** on reconstructing remote spaces using 360° video and 3D Gaussian Splatting to enable **free exploration and interaction** between physically distant users
