...
### 🚃 [**트램스케이프 투 코리아(TramscapeToKoea)**](https://github.com/BynPlay/TramScape-To-Korea): *플레이어 움직임으로 상호작용하는 실감형 기차 여행 게임*
- **장르:** 모션 컨트롤 게임 | **역할**: TPM & Producer | **팀 구성**: 아트 1 · 프로그래밍 4 
- **소개:** 플레이어의 신체 움직임으로 창밖 시점이 바뀌며, 한국의 관광 명소 풍경을 나레이션과 함께 탐험하는 열차 관광 게임 **[컨셉]** 2D 화면에서도 입체감을 제공하는 키넥트 기반 "창문" 인터랙션 메타포 설계 및 구현 (IxD, 인지심리학 기반) **[렌더링]** 한국 랜드마크 모델링 + HDRP 포스트 프로세싱 **[게임플레이]** 스플라인 기반 열차 이동, AI 투어 음성, 몸동작으로 창 밖 콘텐츠 탐색
