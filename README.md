...
- **Client**: 3DGS scene compositing and depth-based visualization in Unity via HLSL Compute Shader | Strea****ming: TCP-based 360° video with GPU-accelerated FFmpeg/NVIDIA NPP | **Backend**: Remote GPU orchestration, automated SfM→3DGS pipeline via Python SSH
