...
I collaborate flexibly across art, programming, and design, understanding each perspective to unify them into a cohesive experience. I value collaboration and knowledge sharing, and I am skilled at exploring and applying technology in ways that enhance user experiences.

저는 아트, 프로그래밍, 기획 등 다양한 직군과 유연하게 협업하며, 각 파트의 관점을 이해하고 하나의 경험으로 조율합니다. 협업과 지식 자산화를 중시하며, 기술과 사용자 경험을 균형 있게 탐구하고 적용하는 역량을 갖추고 있습니다.
...
![Slack](https://img.shields.io/badge/Slack-4A154B?style=flat-square&logo=chatbot&logoColor=white)
...
![Premiere Pro](https://img.shields.io/badge/Premiere_Pro-9999FF?style=flat-square&logo=adobe&logoColor=white)
...
- **Genre:** Serious Game | **Role**: Team Lead (PM & Lead Dev) | **Team**: Planning 2 · Art 3 · Programming 3 
- **Introduce:** An **immersive AR game** where kids take on missions in **a pastel storybook world**, while **AI detects for ADHD symptoms** and **tailors the behavioral development content** in real time.
- **[Narrative]**  Storytelling, art direction, and interaction design for children aged 8–12 with ADHD. **[System]** Built medical AI model, converted to ONNX, and integrated into Unity for real-time gameplay adaptation **[Mechanics]** Translated clinical diagnostic criteria (DSM-5) into game scenarios that capture behavioral data, with full logging pipeline
...
- **Genre:** Motion Game | **Role**: TPM & Producer | Team: Art 1 · Programming 4 
...
- **Genre:** Metaverse | **Role**: Service Planning & Prototyp Developing | Team: Planning 1 · Planning & Programming 1
...
- **Role:** First Author (Research Design & Game Client Development) | **Team**: Client 1 · Backend 1 · Data Analysis 1
