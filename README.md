...
- **소개:** 3D 뉴럴 렌더링 + 360° 영상 스트리밍을 활용해 원격 사용자 간 협업 공간 공유와 상호작용 가능성을 탐구하는 연구 프로젝트. **[연구]** 선행 연구 리뷰 및 연구 공백 확인, 3DGS 기반 공간 탐색 및 시각적 상호작용을 위한 디자인 스페이스 설계 **[개발]** Unity·HLSL 기반 게임 엔진과 Python·CUDA 파이프라인을 연동해 360° 스트리밍·영상 데이터 수집·원격 3DGS 재구성 자동화 및 렌더링 정보 기반 인터랙션 기법 구현 **[사용자 실험]** N=24 사용자 실험을 통해 렌더링 지연과 사용자 신뢰도 관계 분석 및 시점 인터랙션 기법 간 차이 통계적 비교
