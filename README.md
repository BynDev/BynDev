...
**변재현, 혁신을 지향하는 프로젝트 매니저 & 소프트웨어 개발자**  
...
저는 아트, 프로그래밍, 기획 등 다양한 직군과 유연하게 협업하며, 각 파트의 관점을 이해하고 하나의 경험으로 조율합니다. 과정의 회고와 자산화를 중시하며, HCI를 통해 기술의 활용과 사용자 중심의 경험을 깊이 있게 탐구하고 분석하는 역량을 쌓았습니다.
